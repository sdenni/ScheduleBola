...
import com.example.s_denni.googledevkotlin_submission3_denni_2.R.drawable.ic_add_to_favorites
import com.example.s_denni.googledevkotlin_submission3_denni_2.R.drawable.ic_added_to_favorites
import com.example.s_denni.googledevkotlin_submission3_denni_2.R.id.nambihan_karesep
import com.example.s_denni.googledevkotlin_submission3_denni_2.R.menu.detail_menu
import com.example.s_denni.googledevkotlin_submission3_denni_2.basisdata.database
import com.example.s_denni.googledevkotlin_submission3_denni_2.models.*
...
//                            centerHorizontally()
        ...
        try {
            database.use {
                insert(Kareseps.TABLE_KARESEP,
                    Kareseps.KODE_SCHEDULE to idSchedule,
                    Kareseps.KODE_KENCA to dataof_myLagaInfo.idKlubKenca,
                    Kareseps.KODE_KATUHU to dataof_myLagaInfo.idKlubKatuhu,
    ...
    private fun removeFromFavorite(){
        try {
            database.use {
                delete(Kareseps.TABLE_KARESEP, "(KODE_SCHEDULE = {kode})",
                    "kode" to idSchedule)
            }
    ...
    private fun setFavorite() {
        Log.d("TRACE","IS FAVORITE ? "+isFavorite)
        if (isFavorite)
